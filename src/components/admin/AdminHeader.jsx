...
Logo
                        ...
                        <li>
                            <details className="group [&_summary::-webkit-details-marker]:hidden">
                                ...
                                <ul className="mt-2 space-y-1 px-4">
                                    <li>
                                        <Link to={'/admin/products/list'} className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                            Product List
                                        </Link>
                                    </li>
                                    <li>
                ...
                <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
                    ...
                    >
                        <img
                            alt="User avatar"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiw5ka6vw_F3-o4qNEq362CSJvjtKtRrBK8SLBt-mdEQ&s"
